...
public class Base85Decoder {
    ...
    /* public static String Base85RotDecode(String stringIn, int rotOffset) {
        String rotDecoded = RotDecoder.RotDecode(stringIn, rotOffset);
        String base64Decoded = Base64Decoder.Base64Decode(rotDecoded);
        String base85Decoded = Base85Decode(base64Decoded);
